...
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/pass_through/mistral.md"
summary: "Pass-through endpoints for Mistral - call provider-specific endpoint, in native format (no translation)."
---
