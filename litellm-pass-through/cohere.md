...
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/pass_through/cohere.md"
summary: "Pass-through endpoints for Cohere - call provider-specific endpoint, in native format (no translation)."
---
