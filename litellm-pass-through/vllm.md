...
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/pass_through/vllm.md"
summary: "Pass-through endpoints for VLLM - call provider-specific endpoint, in native format (no translation)."
---
