---
title: "Vertex AI Live API WebSocket Passthrough"
category: "litellm-pass-through"
tags:
  - litellm
  - litellm-pass-through
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/pass_through/vertex_ai_live_websocket.md"
summary: "LiteLLM now supports WebSocket passthrough for the Vertex AI Live API, enabling real-time bidirectional communication with Gemini models."
---
