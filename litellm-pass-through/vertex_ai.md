...
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/pass_through/vertex_ai.md"
summary: "Pass-through endpoints for Vertex AI - call provider-specific endpoint, in native format (no translation)."
---
