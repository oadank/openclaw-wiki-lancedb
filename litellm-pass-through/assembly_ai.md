...
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/pass_through/assembly_ai.md"
summary: "Pass-through endpoints for AssemblyAI - call AssemblyAI endpoints, in native format (no translation)."
---
