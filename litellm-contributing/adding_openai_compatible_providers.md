...
category: "litellm-contributing"
tags:
  - litellm
  - litellm-contributing
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/contributing/adding_openai_compatible_providers.md"
summary: "For simple OpenAI-compatible providers (like Hyperbolic, Nscale, etc.), you can add support by editing a single JSON file."
---
