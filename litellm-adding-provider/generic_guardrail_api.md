---
title: "[BETA] Generic Guardrail API - Integrate Without a PR"
category: "litellm-adding-provider"
tags:
  - litellm
  - litellm-adding-provider
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/adding_provider/generic_guardrail_api.md"
summary: "As a guardrail provider, integrating with LiteLLM traditionally requires:"
---
