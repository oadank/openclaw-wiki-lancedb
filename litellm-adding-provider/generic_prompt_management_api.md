---
title: "[BETA] Generic Prompt Management API - Integrate Without a PR"
category: "litellm-adding-provider"
tags:
  - litellm
  - litellm-adding-provider
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/adding_provider/generic_prompt_management_api.md"
summary: "As a prompt management provider, integrating with LiteLLM traditionally requires:"
---
