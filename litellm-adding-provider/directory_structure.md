...
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/adding_provider/directory_structure.md"
summary: "When adding a new provider, you need to create a directory for the provider that follows the following structure:"
---
