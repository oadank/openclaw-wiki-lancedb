---
title: "Add Rerank Provider"
category: "litellm-adding-provider"
tags:
  - litellm
  - litellm-adding-provider
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/adding_provider/new_rerank_provider.md"
summary: "LiteLLM **follows the Cohere Rerank API format** for all rerank providers. Here's how to add a new rerank provider:"
---
