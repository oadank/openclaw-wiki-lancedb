...
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/integrations/letta.md"
summary: "[Letta](https://github.com/letta-ai/letta) (formerly MemGPT) is a framework for building stateful LLM agents with persistent memory. This guide shows how to integrate both LiteLLM SDK and LiteLLM Prox"
---
