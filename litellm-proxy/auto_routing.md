...
tags:
  ...
  - litellm-proxy
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/proxy/auto_routing.md"
summary: "LiteLLM can auto select the best model for a request based on rules you define."
---
