...
tags:
  ...
  - litellm-proxy
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/proxy/fallback_management.md"
summary: "Dedicated endpoints for managing model fallbacks separately from the general configuration."
---
