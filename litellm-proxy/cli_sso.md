...
tags:
  ...
  - litellm-proxy
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/proxy/cli_sso.md"
summary: "Use the litellm cli to authenticate to the LiteLLM Gateway. This is great if you're trying to give a large number of developers self-serve access to the LiteLLM Gateway."
---
...
#### ⚠️ Warning[Beta Feature - Required]
...
#### ℹ️ Note[Experimental UI Session]
