---
title: "Per-Team/Project Credential Routing"
category: "litellm-proxy"
tags:
  - litellm
  - litellm-proxy
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/proxy/credential_routing.md"
summary: "Route the same model to different LLM provider endpoints (e.g. different Azure instances) based on which team or project makes the request."
---
