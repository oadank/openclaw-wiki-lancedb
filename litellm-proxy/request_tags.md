...
tags:
  ...
  - litellm-proxy
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/proxy/request_tags.md"
summary: "Add tags to model deployments to track spend by environment, AWS account, or any custom label."
---
