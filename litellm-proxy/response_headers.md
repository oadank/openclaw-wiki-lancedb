...
tags:
  ...
  - litellm-proxy
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/proxy/response_headers.md"
summary: "When you make a request to the proxy, the proxy will return the following headers:"
---
