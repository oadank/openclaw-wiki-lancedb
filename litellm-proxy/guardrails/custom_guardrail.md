...
tags:
  ...
  - litellm-proxy
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/proxy/guardrails/custom_guardrail.md"
summary: "Use this if you want to write code to run a custom guardrail"
---
...
#### ℹ️ Note Streaming and post_call guardrails
