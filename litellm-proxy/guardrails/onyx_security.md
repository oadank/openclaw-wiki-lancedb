...
tags:
  ...
  - litellm-proxy
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/proxy/guardrails/onyx_security.md"
summary: "Go to [Onyx's platform](https://app.onyx.security) and create a new AI Guard policy."
---
