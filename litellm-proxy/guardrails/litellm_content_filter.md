---
title: "LiteLLM Content Filter (Built-in Guardrails)"
category: "litellm-proxy"
tags:
  - litellm
  - litellm-proxy
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/proxy/guardrails/litellm_content_filter.md"
summary: "Built-in guardrail** for detecting and filtering sensitive information using regex patterns and keyword matching. No external dependencies required."
---
...
#### ℹ️ Info Bias Detection Considerations
