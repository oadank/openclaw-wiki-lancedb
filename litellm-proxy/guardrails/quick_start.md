...
tags:
  ...
  - litellm-proxy
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/proxy/guardrails/quick_start.md"
summary: "Setup Prompt Injection Detection, PII Masking on LiteLLM Proxy (AI Gateway)"
---
