---
title: "✨ Secret Detection/Redaction (Enterprise-only)"
category: "litellm-proxy"
tags:
  - litellm
  - litellm-proxy
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/proxy/guardrails/secret_detection.md"
summary: "❓ Use this to REDACT API Keys, Secrets sent in requests to an LLM. "
---
