...
tags:
  ...
  - litellm-proxy
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/proxy/guardrails/guardrails_ai.md"
summary: "Use Guardrails AI ([guardrailsai.com](https://www.guardrailsai.com/)) to add checks to LLM output."
---
