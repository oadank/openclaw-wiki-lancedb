...
tags:
  ...
  - litellm-proxy
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/proxy/guardrails/crowdstrike_aidr.md"
summary: "The CrowdStrike AIDR guardrail uses configurable detection policies to identify"
---
