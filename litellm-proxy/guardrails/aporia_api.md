...
tags:
  ...
  - litellm-proxy
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/proxy/guardrails/aporia_api.md"
summary: "Use [Aporia](https://www.aporia.com/) to  detect PII in requests and profanity in responses"
---
