...
tags:
  ...
  - litellm-proxy
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/proxy/model_access.md"
summary: "Set allowed models for a key using the `models` param"
---
