---
title: "Multi-Tenant Architecture with LiteLLM"
category: "litellm-proxy"
tags:
  - litellm
  - litellm-proxy
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/proxy/multi_tenant_architecture.md"
summary: "LiteLLM provides a centralized solution that scales across multiple tenants, enabling organizations to:"
---
...
#### ℹ️ Info Open Source vs. Enterprise
...
#### ℹ️ Info Enterprise vs. Open Source Setup
