---
title: "Docker Image Security Guide"
category: "litellm-proxy"
tags:
  - litellm
  - litellm-proxy
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/proxy/docker_image_security.md"
summary: "LiteLLM signs every Docker image published to GHCR with [cosign](https://docs.sigstore.dev/cosign/overview/) starting from **v1.83.0**. This page covers how to verify signatures, enforce verification "
---
