...
tags:
  ...
  - litellm-proxy
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/proxy/caching.md"
summary: ":::note"
---
...
#### ℹ️ Info IAM authentication for redis is only supported via GCP and only on Redis Clusters for now.
