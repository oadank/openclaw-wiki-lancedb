...
tags:
  ...
  - litellm-proxy
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/proxy/forward_client_headers.md"
summary: "Control which model groups can forward client headers to the underlying LLM provider APIs."
---
