...
tags:
  ...
  - litellm-proxy
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/proxy/ui.md"
summary: "Create keys, track spend, add models without worrying about the config / CRUD endpoints."
---
