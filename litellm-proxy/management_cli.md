...
tags:
  ...
  - litellm-proxy
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/proxy/management_cli.md"
summary: "The `litellm-proxy` CLI is a command-line tool for managing your LiteLLM proxy"
---
...
#### ⚠️ Warning[Beta Feature - Required Environment Variable]
