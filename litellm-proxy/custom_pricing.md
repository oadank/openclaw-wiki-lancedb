...
tags:
  ...
  - litellm-proxy
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/proxy/custom_pricing.md"
summary: "LiteLLM provides flexible cost tracking and pricing customization for all LLM providers:"
---
