---
title: "Agentic Loop Hook"
category: "litellm-proxy"
tags:
  - litellm
  - litellm-proxy
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/proxy/agentic_loop_hook.md"
summary: "Build a `CustomLogger` callback that intercepts a model response, fulfills tool calls server-side, and reruns the model — transparently to the caller."
---
