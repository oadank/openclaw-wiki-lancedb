...
tags:
  ...
  - litellm-completion
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/completion/anthropic_advisor_tool.md"
summary: "Pair a faster executor model with a higher-intelligence advisor model that provides strategic guidance mid-generation."
---
