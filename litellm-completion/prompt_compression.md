---
title: "Prompt Compression (`compress()`)"
category: "litellm-completion"
tags:
  - litellm
  - litellm-completion
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/completion/prompt_compression.md"
summary: "Use `litellm.compress()` to shrink long conversation history before calling `completion()`."
---
