---
title: "Shared Session Support"
category: "litellm-completion"
tags:
  - litellm
  - litellm-completion
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/completion/shared_session.md"
summary: "LiteLLM now supports sharing `aiohttp.ClientSession` instances across multiple API calls to avoid creating unnecessary new sessions. This improves performance and resource utilization."
---
