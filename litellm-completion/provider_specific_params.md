...
tags:
  ...
  - litellm-completion
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/completion/provider_specific_params.md"
summary: "Providers might offer params not supported by OpenAI (e.g. top_k). LiteLLM treats any non-openai param, as a provider-specific param, and passes it to the provider in the request body, as a kwarg. [**"
---
