---
title: "Message Sanitization for Tool Calling for anthropic models"
category: "litellm-completion"
tags:
  - litellm
  - litellm-completion
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/completion/message_sanitization.md"
summary: "Automatically fix common message formatting issues when using tool calling with `modify_params=True`**"
---
