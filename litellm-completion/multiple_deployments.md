...
tags:
  ...
  - litellm-completion
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/completion/multiple_deployments.md"
summary: "If you have multiple deployments of the same model, you can pass the list of deployments, and LiteLLM will return the first result. "
---
