---
title: "Image Generation in Chat Completions, Responses API"
category: "litellm-completion"
tags:
  - litellm
  - litellm-completion
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/completion/image_generation_chat.md"
summary: "This guide covers how to generate images when using the `chat/completions`. Note - if you want this on Responses API please file a Feature Request [here](https://github.com/BerriAI/litellm/issues/new)"
---
