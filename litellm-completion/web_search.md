...
tags:
  ...
  - litellm-completion
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/completion/web_search.md"
summary: "Use web search with litellm"
---
...
#### ⚠️ Warning Important: Only Search Models Support `web_search_options`
