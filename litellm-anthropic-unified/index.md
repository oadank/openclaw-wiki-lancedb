...
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/anthropic_unified/index.md"
summary: "Use LiteLLM to call all your LLM APIs in the Anthropic `v1/messages` format. "
---
