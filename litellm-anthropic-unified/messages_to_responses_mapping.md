---
title: "v1/messages → /responses Parameter Mapping"
category: "litellm-anthropic-unified"
tags:
  - litellm
  - litellm-anthropic-unified
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/anthropic_unified/messages_to_responses_mapping.md"
summary: "When you send a request to `/v1/messages` targeting an OpenAI or Azure model, LiteLLM internally routes it through the OpenAI Responses API. This page documents exactly how every parameter gets transl"
---
