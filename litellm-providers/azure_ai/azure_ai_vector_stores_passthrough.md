---
title: "Azure AI Search - Vector Store (Passthrough API)"
category: "litellm-providers"
tags:
  - litellm
  - litellm-providers
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/providers/azure_ai/azure_ai_vector_stores_passthrough.md"
summary: "Use this to allow developers to **create** and **search** vector stores using the Azure AI Search API in the **native** Azure AI Search API format, without giving them the Azure AI credentials."
---
