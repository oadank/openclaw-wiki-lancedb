---
title: "[BETA] Google AI Studio (Gemini) Files API"
category: "litellm-providers"
tags:
  - litellm
  - litellm-providers
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/providers/google_ai_studio/files.md"
summary: "Use this to upload files to Google AI Studio (Gemini)."
---
