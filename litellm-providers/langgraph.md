...
tags:
  ...
  - litellm-providers
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/providers/langgraph.md"
summary: "Call LangGraph agents through LiteLLM using the OpenAI chat completions format."
---
