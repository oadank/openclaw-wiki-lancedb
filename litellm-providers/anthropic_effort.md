---
title: "Anthropic Effort Parameter"
category: "litellm-providers"
tags:
  - litellm
  - litellm-providers
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/providers/anthropic_effort.md"
summary: "Control how many tokens Claude uses when responding with the `effort` parameter, trading off between response thoroughness and token efficiency."
---
