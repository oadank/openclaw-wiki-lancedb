---
title: "Azure AI Search - Vector Store (Unified API)"
category: "litellm-providers"
tags:
  - litellm
  - litellm-providers
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/providers/azure_ai_vector_stores.md"
summary: "Use this to **search** Azure AI Search Vector Stores, with LiteLLM's unified `/chat/completions` API."
---
