...
tags:
  ...
  - litellm-providers
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/providers/openai/responses_api.md"
summary: "```python showLineNumbers title="OpenAI Non-streaming Response""
---
