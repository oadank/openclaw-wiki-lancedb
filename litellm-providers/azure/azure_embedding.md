...
tags:
  ...
  - litellm-providers
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/providers/azure/azure_embedding.md"
summary: "This can be set as env variables or passed as **params to litellm.embedding()**"
---
