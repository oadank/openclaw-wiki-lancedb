...
tags:
  ...
  - litellm-providers
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/providers/bedrock.md"
summary: "ALL Bedrock models (Anthropic, Meta, Deepseek, Mistral, Amazon, etc.) are Supported"
---
