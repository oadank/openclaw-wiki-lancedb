...
tags:
  ...
  - litellm-providers
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/providers/chatgpt.md"
summary: "Use ChatGPT Pro/Max subscription models through LiteLLM with OAuth device flow authentication."
---
