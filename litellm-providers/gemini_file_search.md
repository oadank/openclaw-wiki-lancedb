...
tags:
  ...
  - litellm-providers
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/providers/gemini_file_search.md"
summary: "Use Google Gemini's File Search for Retrieval Augmented Generation (RAG) with LiteLLM."
---
