...
tags:
  ...
  - litellm-providers
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/providers/gemini/videos.md"
summary: "LiteLLM supports Google's Veo video generation models through a unified API interface."
---
