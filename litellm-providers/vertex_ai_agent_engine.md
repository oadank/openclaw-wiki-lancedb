...
tags:
  ...
  - litellm-providers
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/providers/vertex_ai_agent_engine.md"
summary: "Call Vertex AI Agent Engine (Reasoning Engines) in the OpenAI Request/Response format."
---
