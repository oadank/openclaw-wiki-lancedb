...
tags:
  ...
  - litellm-providers
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/providers/openai.md"
summary: "LiteLLM supports OpenAI Chat + Embedding calls."
---
...
#### ℹ️ Info Metadata passthrough (preview)
