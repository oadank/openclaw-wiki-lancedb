...
summary: "Fix Chrome/Brave/Edge/Chromium CDP startup issues on Linux, especially with snap Chromium"
tags: ["tools", "browser", "troubleshooting", "linux"]
sources: ["/opt/openclaw/data/workspace/refs/openclaw-docs/docs/tools/browser-linux-troubleshooting.md"]
provenance: {
  extracted: 1.0,
  inferred: 0.0,
  ambiguous: 0.0
...
- [[browser-wsl2-windows-remote-cdp|WSL2 + Windows Remote CDP]] — Browser troubleshooting for WSL2 + Windows split-host setups
- [[gateway/sandboxing|Sandboxing]] — Browser sandbox configuration and isolation
- [[troubleshooting|Troubleshooting]] — General OpenClaw troubleshooting
