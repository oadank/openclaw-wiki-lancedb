...
tags: [installation]
sources:
  - refs/openclaw-docs/docs/install/macos-vm.md
summary: "OpenClaw on macOS VMs (Sandboxing)"
...
provenance:
  ...
  ambiguous: 0.0
sources:
  - "/opt/openclaw/data/workspace/refs/openclaw-docs/docs/install/macos-vm.md"
---
