---
title: "Hosted Cache - api.litellm.ai"
category: "litellm-caching"
tags:
  - litellm
  - litellm-caching
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/caching/caching_api.md"
summary: "Use api.litellm.ai for caching `completion()` and `embedding()` responses"
---
