...
category: "litellm-debugging"
tags:
  - litellm
  - litellm-debugging
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/debugging/local_debugging.md"
summary: "There's 2 ways to do local debugging - `litellm._turn_on_debug()` and by passing in a custom function `completion(...logger_fn=<your_local_function>)`. Warning: Make sure to not use `_turn_on_debug()`"
---
