---
title: "Call any LiteLLM model in your custom format"
category: "litellm-extras"
tags:
  - litellm
  - litellm-extras
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/extras/creating_adapters.md"
summary: "Use this to call any LiteLLM supported `.completion()` model, in your custom format. Useful if you have a custom API and want to support any LiteLLM supported model."
---
