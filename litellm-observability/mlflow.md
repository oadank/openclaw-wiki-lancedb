---
title: "🔁 MLflow - OSS LLM Observability and Evaluation"
category: "litellm-observability"
tags:
  - litellm
  - litellm-observability
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/observability/mlflow.md"
summary: "MLflow** is an end-to-end open source MLOps platform for [experiment tracking](https://www.mlflow.org/docs/latest/tracking.html), [model management](https://www.mlflow.org/docs/latest/models.html), [e"
---
