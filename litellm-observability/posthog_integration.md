---
title: "PostHog - Tracking LLM Usage Analytics"
category: "litellm-observability"
tags:
  - litellm
  - litellm-observability
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/observability/posthog_integration.md"
summary: "PostHog is an open-source product analytics platform that helps you track and analyze how users interact with your product. For LLM applications, PostHog provides specialized AI features to track mode"
---
