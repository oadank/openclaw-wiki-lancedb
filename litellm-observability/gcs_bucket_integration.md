...
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/observability/gcs_bucket_integration.md"
summary: "Log LLM Logs to [Google Cloud Storage Buckets](https://cloud.google.com/storage?hl=en)"
---
