...
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/observability/ramp_integration.md"
summary: "Send AI usage and cost data to Ramp for automated spend tracking."
---
