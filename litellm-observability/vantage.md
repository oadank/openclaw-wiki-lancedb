...
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/observability/vantage.md"
summary: "LiteLLM can export proxy spend data to [Vantage](https://vantage.sh) as [FOCUS 1.2](https://focus.finops.org/) formatted cost reports. This lets you visualize LLM spend alongside your cloud infrastruc"
---
