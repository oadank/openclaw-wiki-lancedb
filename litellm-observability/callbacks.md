...
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/observability/callbacks.md"
summary: "liteLLM provides `input_callbacks`, `success_callbacks` and `failure_callbacks`, making it easy for you to send data to a particular provider depending on the status of your responses."
---
