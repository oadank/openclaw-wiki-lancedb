...
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/observability/sumologic_integration.md"
summary: "Send LiteLLM logs to Sumo Logic for observability, monitoring, and analysis."
---
