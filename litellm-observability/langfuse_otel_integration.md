...
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/observability/langfuse_otel_integration.md"
summary: "The Langfuse OpenTelemetry integration allows you to send LiteLLM traces and observability data to Langfuse using the OpenTelemetry protocol. This provides a standardized way to collect and analyze yo"
---
