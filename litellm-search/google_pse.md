---
title: "Google Programmable Search Engine (PSE)"
category: "litellm-search"
tags:
  - litellm
  - litellm-search
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/search/google_pse.md"
summary: "Get API Key:** [Google Cloud Console](https://console.cloud.google.com/apis/credentials)  "
---
