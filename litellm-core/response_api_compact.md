...
tags:
  ...
  - core
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/response_api_compact.md"
summary: "Compress conversation history using OpenAI's `/responses/compact` endpoint."
---
