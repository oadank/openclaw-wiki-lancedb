---
title: "A2A Agent Authentication Headers"
category: "litellm-core"
tags:
  - litellm
  - core
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/a2a_agent_headers.md"
summary: "Forward authentication credentials (Bearer tokens, API keys, etc.) from clients to backend A2A agents."
---
