...
tags:
  ...
  - core
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/response_api.md"
summary: "LiteLLM provides an endpoint in the spec of [OpenAI's `/responses` API](https://platform.openai.com/docs/api-reference/responses)"
---
