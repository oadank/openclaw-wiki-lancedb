...
tags:
  ...
  - core
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/a2a_iteration_budgets.md"
summary: "Control runaway costs from agentic loops with per-session iteration and budget caps."
---
