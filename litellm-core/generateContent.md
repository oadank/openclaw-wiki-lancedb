...
tags:
  ...
  - core
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/generateContent.md"
summary: "Use LiteLLM to call Google AI's generateContent endpoints for text generation, multimodal interactions, and streaming responses."
---
