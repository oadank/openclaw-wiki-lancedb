...
tags:
  ...
  - core
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/a2a_agent_permissions.md"
summary: "Control which A2A agents can be accessed by specific keys or teams in LiteLLM."
---
