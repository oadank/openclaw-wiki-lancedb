...
tags:
  ...
  - core
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/rag_ingest.md"
summary: "All-in-one document ingestion pipeline: **Upload → Chunk → Embed → Vector Store**"
---
...
#### ℹ️ Info Vertex AI Prerequisites
...
#### ℹ️ Info S3 Vectors Auto-Creation
