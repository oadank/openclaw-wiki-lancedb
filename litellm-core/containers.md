...
tags:
  ...
  - core
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/containers.md"
summary: "Manage OpenAI code interpreter containers (sessions) for executing code in isolated environments."
---
