...
tags:
  ...
  - core
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/benchmarks.md"
summary: "Benchmarks for LiteLLM Gateway (Proxy Server) tested against a fake OpenAI endpoint."
---
