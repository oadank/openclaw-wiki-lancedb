---
title: "SDK Proxy Authentication (OAuth2/JWT Auto-Refresh)"
category: "litellm-core"
tags:
  - litellm
  - core
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/proxy_auth.md"
summary: "Automatically obtain and refresh OAuth2/JWT tokens when using the LiteLLM Python SDK with a LiteLLM Proxy that requires JWT authentication."
---
