...
tags:
  ...
  - core
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/prompt_management.md"
summary: "Use LiteLLM Prompt Management with `/v1/responses` by passing `prompt_id` and optional `prompt_variables`."
---
