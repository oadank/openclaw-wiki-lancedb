...
tags:
  ...
  - core
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/anthropic_count_tokens.md"
summary: "Anthropic-compatible token counting endpoint. Count tokens for messages before sending them to the model."
---
