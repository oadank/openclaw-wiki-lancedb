---
title: "Contribute Custom Webhook API"
category: "litellm-contribute-integration"
tags:
  - litellm
  - litellm-contribute-integration
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/contribute_integration/custom_webhook_api.md"
summary: "If your API just needs a Webhook event from LiteLLM, here's how to add a 'native' integration for it on LiteLLM: "
---
