...
| 来源 | 文档数 | 说明 |
|------|--------|------|
| [OpenClaw 官方文档](https://docs.openclaw.ai) | 487 | OpenClaw 官方文档全量吸收（2026-04-28 同步最新） |
...
- **Wiki 页面数**：826 页（向量库 826 页）
- **已入库来源**：487 个（OpenClaw 官方文档 304 个文件变更已同步）
- **向量库**：LanceDB，BGE Small ZH v1.5，512 维
- **搜索模式**：grep 精确 + 向量语义 + BM25 + Rerank 双重验证
