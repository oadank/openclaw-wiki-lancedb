---
title: "SSL, HTTP Proxy Security Settings"
category: "litellm-guides"
tags:
  - litellm
  - litellm-guides
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/guides/security_settings.md"
summary: "If you're in an environment using an older TTS bundle, with an older encryption, follow this guide. By default"
---
