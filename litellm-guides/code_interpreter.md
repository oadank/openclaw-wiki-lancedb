...
tags:
  ...
  - litellm-guides
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/guides/code_interpreter.md"
summary: "Use OpenAI's Code Interpreter tool to execute Python code in a secure, sandboxed environment."
---
