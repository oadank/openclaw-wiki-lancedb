---
title: "/vector_stores - Create Vector Store"
category: "litellm-vector-stores"
tags:
  - litellm
  - litellm-vector-stores
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/vector_stores/create.md"
summary: "Create a vector store which can be used to store and search document chunks for retrieval-augmented generation (RAG) use cases."
---
