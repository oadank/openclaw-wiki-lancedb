---
title: "Latency Overhead Troubleshooting"
category: "litellm-troubleshoot"
tags:
  - litellm
  - litellm-troubleshoot
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/troubleshoot/latency_overhead.md"
summary: "Use this guide when you see unexpected latency overhead between LiteLLM proxy and the LLM provider."
---
