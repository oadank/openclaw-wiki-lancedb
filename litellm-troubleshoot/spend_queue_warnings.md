---
title: "Spend Update Queue Full Warnings"
category: "litellm-troubleshoot"
tags:
  - litellm
  - litellm-troubleshoot
sources:
  - "/opt/openclaw/data/workspace/refs/litellm-docs/docs/troubleshoot/spend_queue_warnings.md"
summary: "The "Spend update queue is full" warning occurs in high-volume LiteLLM proxy deployments when the internal spend tracking queue reaches capacity. This is a protective mechanism to prevent memory issue"
---
